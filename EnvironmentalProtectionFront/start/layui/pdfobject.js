...
(function (root, factory) {
    ...
    embed = function(url, targetSelector, options){
        ...
        var id = (options.id && typeof options.id === "string") ? "id='" + options.id + "'" : "",
            ...
            fallbackHTML = "",
            pdfOpenFragment = "",
            fallbackHTML_default = "<p>您当前的浏览器不支持当前页面打开. 请点击 <a id=\"view_pdf\" href='[url]' target=\"pdf_frame\">跳转页面</a></p>";
        ...
        if(forcePDFJS && PDFJS_URL){
            ...
            if(PDFJS_URL){
                ...
                //火狐浏览器兼容代码
                document.getElementById("view_pdf").click();
                var height = (window.innerHeight - 184) + 'px';
                document.getElementById("pdf_frame").style.height = height;
                document.getElementById("pdf_frame").style.display="";
                document.getElementById("attachment_file").style.display="none";
            }
