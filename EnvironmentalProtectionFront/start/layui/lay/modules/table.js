...
;layui.define(["laytpl", "laypage", "layer", "form"], function (e) {
    ...
    S.prototype.config = {
        ...
        //     }))
        // })
            , a.layBody.on("click", "tr", function () {
            var e = t(this), i = (e.data("field"), e.data("edit")), o = e.children(h);
            a.layBody.find("tr").each(function (){
                t(this).css("background","");
                t(this).css("opacity","1");
            });
            t(e).css("background-color","rgba(140,224,77,0.5)");
            t(e).find("td").each(function (){
                if (t(this).attr("data-edit") == "text") {
                    t(this).css("background-color","#FFFFFF");
                    t(this).css("border","2px solid  rgba(140,224,77,0.5)");
                }
            });
