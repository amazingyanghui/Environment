...
function(a){for(var a=a.split("."),b=window,c=0;c<a.length;c++)b[a[c]]||(b[a[c]]={}),b=b[a[c]]};GeoGlobe.VERSION_NUMBER="GeoGlobeJSAPI 6.4 -- $Version: 1.44.180605 build-2018-08-01 13:49:43 $"})();GeoGlobe.Class=function(){var a=arguments.length,b=arguments[0],c=arguments[a-1],d=typeof c.initialize=="function"?c.initialize:function(){b.prototype.initialize.apply(this,arguments)};a>1?[d,b].concat(Array.prototype.slice.call(arguments).slice(1,a-1),c):d.prototype=c;return d};
...
v.url=a;u=a.endsWith("?")?GeoGlobe.ProxyHost+a+b:GeoGlobe.ProxyHost+a+"?"+b;v.url_tmpl=u;GeoGlobe.Util.randomStr(10);if(e.bounds)var x=[e.bounds._sw.lng,e.bounds._sw.lat,e.bounds._ne.lng,e.bounds._ne.lat];else e.BoundingBox&&(x=e.BoundingBox[0].bounds.toBBOX());var z=d.tileMatrixSets[e.tileMatrixSetLinks[0].tileMatrixSet].matrixIds[0].identifier;this.GetStyle(l[0],function(a){var b={name:e.identifier,sprite:a.sprite?GeoGlobe.ProxyHost+a.sprite:"",glyphs:a.glyphs?GeoGlobe.ProxyHost+a.glyphs:"",styleName:a.styleName,
srs:r,bbox:x,format:e.formats,zoomoffset:z},c="source_vts_"+GeoGlobe.Util.randomStr(6);v.source_id=c;v.source={type:"vector",tiles:[u]};if(a.styleData)for(var d=0;d<a.styleData.layers.length;d++)a.styleData.layers[d].metadata=b,a.styleData.layers[d].source=c,v.layers[d]=a.styleData.layers[d];else for(d=0;d<a.layers.length;d++)a.layers[d].metadata=b,a.layers[d].source=c,v.layers[d]=a.layers[d]},function(){alert("WMTS\u670d\u52a1\u8bf7\u6c42\u5931\u8d25\uff0c\u8bf7\u68c0\u67e5\u670d\u52a1\u662f\u5426\u6b63\u5e38\u8fd0\u884c\u6216\u8bf7\u6c42\u5730\u5740\u662f\u5426\u6b63\u786e\u3002\n\u8bf7\u6c42\u5730\u5740\uff1a"+
...
GeoGlobe.Service.RTDS=GeoGlobe.Class4OL(GeoGlobe.Service,{service:"RTDS",version:"1.0.0",format:"json",callback:"",initialize:function(a,b,c){GeoGlobe.Service.prototype.initialize.apply(this,arguments);GeoGlobe.Util.extend(this,c)},getCapabilities:function(a,b){GeoGlobe.Request.GET({url:this.url,params:{SERVICE:this.service,VERSION:this.version,REQUEST:"GetCapabilities",FORMAT:this.format,CALLBACK:this.callback},scope:this,async:this.async,success:function(c){var d={};try{d=JSON.parse(c.responseText)}catch(e){console.error("RTDS GetCapabilities Error : "+
c.responseText);b(c.responseText);return}a(d)},failure:b});return this},describeFeatureDataSet:function(a,b,c){GeoGlobe.Request.GET({url:this.url,params:{SERVICE:this.service,VERSION:this.version,REQUEST:"DescribeFeatureDataSet",FORMAT:this.format,CALLBACK:this.callback,OBSOBJSETNAME:a},scope:this,async:this.async,success:function(a){var e={};try{e=JSON.parse(a.responseText)}catch(f){console.error("RTDS DescribeFeatureDataSet Error : "+a.responseText);c(a.responseText);return}b(e)},failure:c});return this},
describeObservationDataSet:function(a,b,c){GeoGlobe.Request.GET({url:this.url,params:{SERVICE:this.service,VERSION:this.version,REQUEST:"DescribeObservationDataSet",FORMAT:this.format,CALLBACK:this.callback,DATASETNAME:a},scope:this,async:this.async,success:function(a){var e={};try{e=JSON.parse(a.responseText)}catch(f){console.error("RTDS DescribeObservationDataSet Error : "+a.responseText);c(a.responseText);return}b(e)},failure:c});return this},queryFeature:function(a,b,c){var d={SERVICE:this.service,
VERSION:this.version,REQUEST:"QueryFeature",FORMAT:this.format,CALLBACK:this.callback,OBSOBJSETNAME:a.obsobjsetname};a.externalid&&(d.EXTERNALID=a.externalid);a.bbox&&(d.BBOX=a.bbox);a.geometry&&(d.GEOMETRY=a.geometry);a.startposition&&(d.STARTPOSITION=a.startposition);a.maxcount&&(d.MAXCOUNT=a.maxcount);GeoGlobe.Request.GET({url:this.url,params:d,scope:this,async:this.async,success:function(a){var d={};try{d=JSON.parse(a.responseText)}catch(g){console.error("RTDS QueryFeature Error : "+a.responseText);
c(a.responseText);return}b(d)},failure:c});return this},getObservation:function(a,b,c){var d={SERVICE:this.service,VERSION:this.version,REQUEST:"GetObservation",FORMAT:this.format,CALLBACK:this.callback,DATASETNAME:a.datasetname};a.externalid&&(d.EXTERNALID=a.externalid);a.observationproperty&&(d.OBSERVATIONPROPERTY=a.observationproperty);a.bbox&&(d.BBOX=a.bbox);a.geometry&&(d.GEOMETRY=a.geometry);a.startposition&&(d.STARTPOSITION=a.startposition);a.maxcount&&(d.MAXCOUNT=a.maxcount);GeoGlobe.Request.GET({url:this.url,
params:d,scope:this,async:this.async,success:function(a){var d={};try{d=JSON.parse(a.responseText)}catch(g){console.error("RTDS GetObservation Error : "+a.responseText);c(a.responseText);return}b(d)},failure:c});return this},getObservationHistory:function(a,b,c){var d={SERVICE:this.service,VERSION:this.version,REQUEST:"GetObservationHistory",FORMAT:this.format,CALLBACK:this.callback,DATASETNAME:a.datasetname,EXTERNALID:a.externalid,STARTTIME:a.starttime,ENDTIME:a.endtime};a.observationproperty&&(d.OBSERVATIONPROPERTY=
a.observationproperty);a.samplemethod&&(d.SAMPLEMETHOD=a.samplemethod);a.samplecount&&(d.SAMPLECOUNT=a.samplecount);GeoGlobe.Request.GET({url:this.url,params:d,scope:this,async:this.async,success:function(a){var d={};try{d=JSON.parse(a.responseText)}catch(g){console.error("RTDS GetObservationHistory Error : "+a.responseText);c(a.responseText);return}b(d)},failure:c});return this},featureAggs:function(a,b,c){var d={SERVICE:this.service,VERSION:this.version,REQUEST:"FeatureAggs",FORMAT:this.format,
CALLBACK:this.callback,DATASETNAME:a.datasetname,STARTTIME:a.starttime,ENDTIME:a.endtime};a.precision&&(d.PRECISION=a.precision);a.aggtype&&(d.AGGTYPE=a.aggtype);a.groupbypro&&(d.GROUPBYPRO=a.groupbypro);a.statisticspro&&(d.STATISTICSPRO=a.statisticspro);a.profilter&&(d.PROFILTER=a.profilter);a.bbox&&(d.BBOX=a.bbox);GeoGlobe.Request.GET({url:this.url,params:d,scope:this,async:this.async,success:function(a){var d={};try{d=JSON.parse(a.responseText)}catch(g){console.error("RTDS FeatureAggs Error : "+
a.responseText);c(a.responseText);return}b(d)},failure:c});return this},CLASS_NAME:"GeoGlobe.Service.RTDS"});
...
this.layers[c].id&&b.push(this.layers[c]);this.layers=b},_removeInnerLayer:function(a){if(a._meshes&&a._meshes instanceof Array&&a._meshes.length>0)for(var b=0;b<a._meshes.length;b++){for(var c=0;c<this._threebox.world.children.length;c++)if(this._threebox.world.children[c].children.length!==0&&this._threebox.world.children[c].children[0].uuid===a._meshes[b].uuid){this._threebox.world.remove(a._meshes[b].parent);break}for(c=0;c<this._threebox.world2.children.length;c++)if(this._threebox.world2.children[c].children.length!==
...
b.name="particles";b.userData.attributes={OriginalData:g,Layer:this};this._three._threebox.addGeoreferencedMesh(b);this._meshes.push(b);this._three._render();var x=0,z;(function B(){requestAnimationFrame(B);x+=0.005;x>1&&(x=0);for(var b=v.attributes.position.array,c=0;c<e.length;c++){if(e[c].length===1)z=e[c][0].getPoint(x);else for(var d=0;d<e[c].length;d++)if(x>=e[c][d].rate1&&x<=e[c][d].rate1+e[c][d].rate2){z=e[c][d].getPoint((x-e[c][d].rate1)/e[c][d].rate2);break}b[c*3]=z.x;b[c*3+1]=z.y;b[c*3+
2]=z.z}v.attributes.position.needsUpdate=!0;a._three._render()})()}});
...
a[1],-1]))});a=new THREE.Line(d,f);c.add(a)})}var g=b.data.geometry.coordinates[0],h=0,j=JSON.parse(b.data.properties.levels);j.forEach(function(a){h+=a});for(var l=b._three._threebox.distaneToWorld(h),n={steps:10,units:"kilometers",properties:{}},o=[],r=[],t=[],m=[],p=[],s=[],q=0;q<g.length;q++){var u=[],v=b._three._threebox.projectToWorld(g[q]);r.push(v.clone());var x=v.clone();x.z=l;t.push(x.clone());u.push(v.clone());u.push(x.clone());m.push(u);p.push(v.clone());s.push(v.clone());u=turf.circle(g[q],
...
s=new THREE.SphereBufferGeometry(0.001,32,16),z=new THREE.Mesh(s,j);z.position.copy(b._three._threebox.projectToWorld([e[0],e[1],0]));z.name="sphereTarget";z.scale.copy((new THREE.Vector3(1,1,1)).multiplyScalar(b._three._threebox.projectedUnitsPerMeter(e[1])));d.add(z);j=new THREE.PointLight(16776960,200,0);j.matrixWorldNeedsUpdate=!0;z.add(j);b._three._threebox.addGeoreferencedMeshToWorld2(c);b._meshes.push(c);b._three._threebox.addGeoreferencedMesh(d);b._meshes.push(d);var d=b._three._threebox.projectToWorld([e[0],
...
this._init()}var c={};this.visualMap&&(c.visualMap=this.visualMap);c.mapbox3D=this.mapbox3D;c.series=[];c.units=this.map.units;c.topTileExtent=this.map._tileExtent;for(var d=0;d<this.layers.length;d++)c.series.push(this.layers[d].getRenderOption());this._echartsgl.setOption(c)},clear:function(){this._echartsgl.clear()},addLayer:function(a){a.id?this.getLayer(a.id)||this.layers.push(a):console.error("\u56fe\u5c42id\u5c5e\u6027\u4e0d\u80fd\u4e3a\u7a7a\uff01")},removeLayer:function(a){for(var b=[],c=
...
this.MarkPointsSet=function(c,d,e){this.legendLabel=c;this.markPoints=d;for(c=d.length;c--;){d[c].weight=(d[c].value-a.minValue)/(a.maxValue-a.minValue);if(isNaN(d[c].weight))d[c].weight=1;if(d[c].weight>1)d[c].weight=1;if(d[c].weight<0)d[c].weight=0;if(GeoGlobe.Util.getType(a._rendererOptions.markPoint.itemStyle.color[e])==="object")a.gradientImageData=GeoGlobe.Util.getGradientImageData(a._rendererOptions.markPoint.itemStyle.color[e]);d[c].color=GeoGlobe.Util.getType(g.color[e])==="object"?"rgba("+
a.gradientImageData[~~(d[c].weight*255+0.5)*4]+","+a.gradientImageData[~~(d[c].weight*255+0.5)*4+1]+","+a.gradientImageData[~~(d[c].weight*255+0.5)*4+2]+","+a.gradientImageData[3]/255+")":b[e]}};this.MarkPointsSet.prototype.updateXY=function(){for(var b=this.markPoints.length;b--;){var c=a._parent.map.project([this.markPoints[b].lon,this.markPoints[b].lat]);this.markPoints[b].x=c.x;this.markPoints[b].y=c.y}};this.MarkPointsSet.prototype.draw=function(a,b){if(d||c[b]!==0){var g=[],n=function(a){for(var b=
0;b<g.length;b++)if(parseInt(g[b].x)===parseInt(a.x)&&parseInt(g[b].y)===parseInt(a.y))return g[b];return null},o=function(){a.fillStyle=t.color;a.beginPath();switch(e){case "square":a.globalCompositeOperation="lighter";a.rect(t.x-f/2,t.y-f/2,f,f);break;case "square2":a.rect(t.x-f/2,t.y-f/2,f,f);break;case "round":a.globalCompositeOperation="lighter",a.arc(t.x,t.y,f/2,0,Math.PI*2,!1)}a.fill()},r=this.markPoints.length;for(this.markPoints=this.markPoints.sort(function(a,b){var c=a.value,d=b.value;
return c>d?-1:c<d?1:0});r--;){var t;t=this.markPoints[r];if(e==="square2"){var m=n(t);if(m){if(t.value>m.value)o(),m.value=t.value}else o(),g.push({x:t.x,y:t.y,value:t.value})}else o()}}}},_initCanvas:function(){this.canvas=[];this.canvasContext=[];this.canvas.push(document.createElement("canvas"));this.canvasContext.push(this.canvas[0].getContext("2d"));this.cacheCanvas=[];this.cacheCanvasContext=[];this.cacheCanvas.push(document.createElement("canvas"));this.cacheCanvasContext.push(this.cacheCanvas[0].getContext("2d"));
this.canvas[0].width=this.cacheCanvas[0].width=this.width=this._parent.map.transform.width;this.canvas[0].height=this.cacheCanvas[0].height=this.height=this._parent.map.transform.height;this.canvas[0].style.position="absolute";this._parent.container.appendChild(this.canvas[0]);this.setVisible(this.visibility)},render:function(){this._initCanvas();var a,b=this;(function d(){requestAnimationFrame(d);if(b._parent.moving||b.RESIZE){for(a=b.markPointsSets.length;a--;)b.markPointsSets[a].updateXY();b.draw();
b.RESIZE&&(b.RESIZE=!1)}if(b.RELOADED)b.drawLegend(b.DRAWINDEX),b.markPointsSets[b.DRAWINDEX].draw(b.cacheCanvasContext[0],b.DRAWINDEX),b.canvas[0].width=b.width,b.canvasContext[0].drawImage(b.cacheCanvas[0],0,0),b.DRAWINDEX++,b.DRAWINDEX===b.legendLabels.length&&(b.RELOADED=!1),b.drawLegend(),b.draw(),b.RELOADED=!1})();this.RENDERED=!0},resize:function(){this.canvas[0].width=this.cacheCanvas[0].width=this.width=this._parent.map.transform.width;this.canvas[0].height=this.cacheCanvas[0].height=this.height=
this._parent.map.transform.height;this.RESIZE=!0},draw:function(){this.cacheCanvas[0].width=this.width;for(var a=0,b=this.markPointsSets.length;a<b;a++)this.markPointsSets[a].draw(this.cacheCanvasContext[0],a);this.canvas[0].width=this.width;this.canvasContext[0].drawImage(this.cacheCanvas[0],0,0)},drawLegend:function(a){if(this._legend&&this._legend.show){if(!this.legendDiv)this.legendDiv=document.createElement("div"),this.legendDiv.style.display=this.visibility?"block":"none",this.legendDiv.style.zIndex=
9999,this.legendDiv.style.position="absolute",this.legendDiv.style["background-color"]=this._legend.backgroundColor,this.legendDiv.style["border-color"]=this._legend.borderColor,this.legendDiv.style["border-width"]=this._legend.borderWidth+"px",this.legendDiv.style["border-radius"]=this._legend.borderRadius+"px",this.legendDiv.style["border-style"]="solid",this.legendDiv.style["box-shadow"]=this._legend.shadowOffsetX+"px "+this._legend.shadowOffsetY+"px "+this._legend.shadowBlur+"px "+this._legend.shadowColor,
this.legendDiv.style.padding=this._legend.padding+"px",this.legendDiv.style.left=this._legend.left!==null?this._legend.left+"px":null,this.legendDiv.style.right=this._legend.right!==null?this._legend.right+"px":null,this.legendDiv.style.top=this._legend.top!==null?this._legend.top+"px":null,this.legendDiv.style.bottom=this._legend.bottom!==null?this._legend.bottom+"px":null,this.legendCanvas=document.createElement("canvas"),this.legendCanvasContext=this.legendCanvas.getContext("2d"),this.legendCanvas.style.display=
"block",this.legendCanvasContext.font=this._legend.textStyle.fontStyle+" "+this._legend.textStyle.fontWeight+" "+this._legend.textStyle.fontSize+"px "+this._legend.textStyle.fontFamily,this.legendDiv.appendChild(this.legendCanvas),this._parent.container.parentNode.parentNode.parentNode.appendChild(this.legendDiv);for(var b=[],c=null,d=0,e=this.legendLabels.length;d<e;d++)for(var c=this._legend.itemSize+10+this.legendCanvasContext.measureText(this.legendLabels[d].toString()).width,f=this._legend.col,
g=0;g<f;g++)d%this._legend.col===g&&(!b[g]||b[g]<c)&&(b[g]=c);for(var h=10,c=10,d=0,e=b.length;d<e;d++)h+=b[d]+10;c+=((this._legend.itemSize<this._legend.textStyle.fontSize?this._legend.textStyle.fontSize:this._legend.itemSize)+10)*(~~(this.legendLabels.length/this._legend.col)+(this.legendLabels.length%this._legend.col===0?0:1));this.legendCanvas.width=h;this.legendCanvas.height=c;var j=function(a,c,d,e){this.legendCanvas.width=h;for(var f=!1,g,j,s=0,a=a!==void 0?a+1:this.legendLabels.length;s<a;s++){j=
0;for(var q=this._legend.col;j<q;j++)if(s%this._legend.col===j){g=10+this._legend.itemSize/2;for(var u=0;u<j;u++)g+=b[u]+10}j=10+this._legend.itemSize/2+((this._legend.itemSize<this._legend.textStyle.fontSize?this._legend.textStyle.fontSize:this._legend.itemSize)+10)*~~(s/this._legend.col);u=q=!1;this.legendCanvasContext.beginPath();switch(this._rendererOptions.markPoint.symbol){case "square":this.legendCanvasContext.rect(g-this._legend.itemSize/2,j-this._legend.itemSize/2,this._legend.itemSize,this._legend.itemSize);
break;case "square2":this.legendCanvasContext.rect(g-this._legend.itemSize/2,j-this._legend.itemSize/2,this._legend.itemSize,this._legend.itemSize);break;case "round":this.legendCanvasContext.arc(g,j,this._legend.itemSize/2,0,Math.PI*2,!1)}c==="mousemove"&&d!==void 0&&e!==void 0&&this.legendCanvasContext.isPointInPath(d,e)&&(f=q=!0);c==="mousedown"&&d!==void 0&&e!==void 0&&this.legendCanvasContext.isPointInPath(d,e)&&(u=!0);this.legendCanvasContext.beginPath();this.legendCanvasContext.font=this._legend.textStyle.fontStyle+
" "+this._legend.textStyle.fontWeight+" "+this._legend.textStyle.fontSize+"px "+this._legend.textStyle.fontFamily;this.legendCanvasContext.rect(g+this._legend.itemSize/2+10,j-this._legend.textStyle.fontSize/2,this.legendCanvasContext.measureText(this.legendLabels[s].toString()).width,this._legend.textStyle.fontSize);c==="mousemove"&&d!==void 0&&e!==void 0&&this.legendCanvasContext.isPointInPath(d,e)&&(f=q=!0);c==="mousedown"&&d!==void 0&&e!==void 0&&this.legendCanvasContext.isPointInPath(d,e)&&(u=
!0);u&&(this._legend.itemStatuses[s]=this._legend.itemStatuses[s]===0?1:0,this.draw());var v=this._legend.itemStatuses[s]===0?"#808080":this._legend.itemColors[s]?this._legend.itemColors[s]:this._rendererOptions.markPoint.itemStyle.color,x=this._legend.itemStatuses[s]===0?"#808080":this._legend.textStyle.color,v=q||u?GeoGlobe.Util.getShadeColor(v,20):v,x=q||u?GeoGlobe.Util.getShadeColor(x,20):x;this.legendCanvasContext.beginPath();switch(this._rendererOptions.markPoint.symbol){case "square":this.legendCanvasContext.rect(g-
this._legend.itemSize/2,j-this._legend.itemSize/2,this._legend.itemSize,this._legend.itemSize);break;case "square2":this.legendCanvasContext.rect(g-this._legend.itemSize/2,j-this._legend.itemSize/2,this._legend.itemSize,this._legend.itemSize);break;case "round":this.legendCanvasContext.arc(g,j,this._legend.itemSize/2,0,Math.PI*2,!1)}this.legendCanvasContext.fillStyle=v;this.legendCanvasContext.fill();this.legendCanvasContext.font=this._legend.textStyle.fontStyle+" "+this._legend.textStyle.fontWeight+
" "+this._legend.textStyle.fontSize+"px "+this._legend.textStyle.fontFamily;this.legendCanvasContext.textAlign="left";this.legendCanvasContext.textBaseline="middle";this.legendCanvasContext.fillStyle=x;this.legendCanvasContext.fillText(this.legendLabels[s],g+this._legend.itemSize/2+10,j)}this.legendCanvas.style.cursor=f?"pointer":"default"}.bind(this);this.legendCanvas.onmousedown=function(a){var b=a.offsetX||a.clientX-(a.target||a.srcElement).getBoundingClientRect().left,c=a.offsetY||a.clientY-(a.target||
a.srcElement).getBoundingClientRect().top;j(void 0,a.type,b,c)};this.legendCanvas.onmousemove=function(a){var b=a.offsetX||a.clientX-(a.target||a.srcElement).getBoundingClientRect().left,c=a.offsetY||a.clientY-(a.target||a.srcElement).getBoundingClientRect().top;j(void 0,a.type,b,c)};j(a)}},addTo:function(a){this._parent=a;this._parent.addLayer(this)},setVisible:function(a){this.visibility=a;this.canvas[0].style.display=a?"block":"none";this.legendDiv&&(this.legendDiv.style.display=a?"block":"none")},
setData:function(a){this.data=a;this.minValue=Number.MAX_VALUE;this.maxValue=Number.MIN_VALUE;for(var b=0;b<a.length;b++){if(a[b].properties.value<this.minValue)this.minValue=a[b].properties.value;if(a[b].properties.value>this.maxValue)this.maxValue=a[b].properties.value}a=new Blob(["function MarkPoint(lon, lat, value) {this.lon = lon;this.lat = lat;this.value = value;}function MarkPointsSet(legendLabel) {this.legendLabel = legendLabel;this.markPoints = [];}var legendLabels = [];var markPointsSets = [];onmessage = function (evt) {var features = evt.data.data;var feature = null;var legendLabel = null;for (var i = 0, len = features.length; i < len; i++) {feature = features[i];legendLabel = feature.properties.type;if (legendLabels.indexOf(legendLabel) === -1) {legendLabels.push(legendLabel);markPointsSets.push(new MarkPointsSet(legendLabel));}markPointsSets[legendLabels.indexOf(legendLabel)].markPoints.push(new MarkPoint(feature.geometry.coordinates[0], feature.geometry.coordinates[1],feature.properties.value));}postMessage({legendLabels: legendLabels,markPointsSets: markPointsSets})}"]);
a=window.URL.createObjectURL(a);a=new Worker(a);a.postMessage({data:this.data});a.onmessage=function(a){this.legendLabels=a.data.legendLabels;for(var b,e=0,f=a.data.markPointsSets.length;e<f;e++)b=new this.MarkPointsSet(a.data.markPointsSets[e].legendLabel,a.data.markPointsSets[e].markPoints,e),b.updateXY(),this.markPointsSets.push(b);this.RELOADED=!0;this.DRAWINDEX=0}.bind(this)}});
...
Math.PI*2})}}};this.MarkPoint.prototype.updatePartXY=function(){var b=a._rendererOptions.markPoint.slope,c,e,f;switch(d){case "column":var n,l;n=this.parts.length%2===0?this.x-h*Math.cos(b)/2-(this.parts.length/2-1)*g-(this.parts.length/2-0.5)*j:this.x+(g-h*Math.cos(b))/2-(this.parts.length-1)/2*g-(this.parts.length-1)/2*j;l=this.y+h*Math.sin(b)/2;for(c=0;c<this.parts.length;c++)for(e=0;e<this.parts[c].cubes.length;e++){var q=0;for(f=e;f>0;f--)q+=this.parts[c].cubes[f-1].height;this.parts[c].cubes[e].vertexs=
[[n+c*(g+j),l-q],[n+c*(g+j)+h*Math.cos(b),l-h*Math.sin(b)-q],[n+c*(g+j)+h*Math.cos(b)-g,l-h*Math.sin(b)-q],[n+c*(g+j)-g,l-q]]}break;case "pie":var u,v,x,z,C,B=Math.PI*2/50;for(c=0;c<1;c++){f=this.parts[c].size/2;n=f>g?f-g:0;q=new this.Point(0,0,-h/2);u=new this.Point(0,0,h/2);v=[];x=[];z=[];C=[];for(l=0;l<=Math.PI*2;)v.push(new this.Point(f*Math.cos(l),f*Math.sin(l),-h/2)),x.push(new this.Point(f*Math.cos(l),f*Math.sin(l),h/2)),n>0&&(z.push(new this.Point(n*Math.cos(l),n*Math.sin(l),-h/2)),C.push(new this.Point(n*
Math.cos(l),n*Math.sin(l),h/2))),l+=B;v.push(new this.Point(f,0,-h/2));x.push(new this.Point(f,0,h/2));n>0&&(z.push(new this.Point(n,0,-h/2)),C.push(new this.Point(n,0,h/2)));e=Math.cos(b);var A=Math.sin(b),w;l=q.y*e-q.z*A;w=q.z*e+q.y*A;q.y=l;q.z=w;l=u.y*e-u.z*A;w=u.z*e+u.y*A;u.y=l;u.z=w;for(f=0;f<50;f++)if(l=v[f].y*e-v[f].z*A,w=v[f].z*e+v[f].y*A,v[f].y=l,v[f].z=w,l=x[f].y*e-x[f].z*A,w=x[f].z*e+x[f].y*A,x[f].y=l,x[f].z=w,n>0)l=z[f].y*e-z[f].z*A,w=z[f].z*e+z[f].y*A,z[f].y=l,z[f].z=w,l=C[f].y*e-C[f].z*
A,w=C[f].z*e+C[f].y*A,C[f].y=l,C[f].z=w;for(e=0;e<this.parts[c].sectors.length;e++){l=this.parts[c].sectors[e].angle;A=0;for(f=e;f>0;f--)A+=this.parts[c].sectors[f-1].angle;f=A+l;this.parts[c].sectors[e].startIndex=e===0?Math.round(A/B):this.parts[c].sectors[e-1].endIndex;this.parts[c].sectors[e].endIndex=Math.round(f/B)}this.parts[c].uCentrePoint=q;this.parts[c].tCentrePoint=u;this.parts[c].oUnderPoints=v;this.parts[c].oTopPoints=x;if(n>0)this.parts[c].iUnderPoints=z,this.parts[c].iTopPoints=C}}};
...
c.lineTo(this.parts[h].cubes[j].vertexs[1][0],this.parts[h].cubes[j].vertexs[1][1]-this.parts[h].cubes[j].height),c.lineTo(this.parts[h].cubes[j].vertexs[3][0],this.parts[h].cubes[j].vertexs[3][1]-this.parts[h].cubes[j].height),c.lineTo(this.parts[h].cubes[j].vertexs[3][0],this.parts[h].cubes[j].vertexs[3][1]),c.isPointInPath(e,f))){a.hoveredMarkPoint=this;this.hActive=h;this.vActive=j;return}break;case "pie":for(h=0;h<1;h++){var q=this.parts[h].tCentrePoint,u=this.parts[h].oUnderPoints,v=this.parts[h].oTopPoints,
x=this.parts[h].iUnderPoints,z=this.parts[h].iTopPoints,C=!1;this.parts[h].size/2>g&&(C=!0);var B=Math.round(25),A=[],w=[],y=[];l=[];for(j=0;j<this.parts[h].sectors.length;j++)A.push(this.parts[h].sectors[j].angle),w.push(this.parts[h].sectors[j].startIndex),y.push(Math.round(this.parts[h].sectors[j].endIndex*this.energy)),l.push(b[j]?b[j]:n.color);for(j=A.length-1;j>=0;j--)if(A[j]>0){c.beginPath();if(w[j]>B){c.moveTo(v[y[j]].get2d().x,v[y[j]].get2d().y);for(l=y[j]-1;l>=w[j];l--)c.lineTo(v[l].get2d().x,
v[l].get2d().y);if(C){c.lineTo(z[w[j]].get2d().x,z[w[j]].get2d().y);for(l=w[j];l<=y[j];l++)c.lineTo(x[l].get2d().x,x[l].get2d().y);c.lineTo(z[y[j]].get2d().x,z[y[j]].get2d().y)}else c.lineTo(q.get2d().x,q.get2d().y)}else if(y[j]<B){c.moveTo(u[y[j]].get2d().x,u[y[j]].get2d().y);for(l=y[j]-1;l>=w[j];l--)c.lineTo(u[l].get2d().x,u[l].get2d().y);c.lineTo(v[w[j]].get2d().x,v[w[j]].get2d().y);if(C)for(l=w[j];l<=y[j];l++)c.lineTo(z[l].get2d().x,z[l].get2d().y);else c.lineTo(q.get2d().x,q.get2d().y);c.lineTo(v[y[j]].get2d().x,
v[y[j]].get2d().y)}else{c.moveTo(v[y[j]].get2d().x,v[y[j]].get2d().y);for(l=y[j]-1;l>=B;l--)c.lineTo(v[l].get2d().x,v[l].get2d().y);for(l=B;l>=w[j];l--)c.lineTo(u[l].get2d().x,u[l].get2d().y);c.lineTo(v[w[j]].get2d().x,v[w[j]].get2d().y);if(C){for(l=w[j];l<=B;l++)c.lineTo(z[l].get2d().x,z[l].get2d().y);for(l=B;l<=y[j];l++)c.lineTo(x[l].get2d().x,x[l].get2d().y)}else c.lineTo(q.get2d().x,q.get2d().y)}if(c.isPointInPath(e,f)){a.hoveredMarkPoint=this;this.hActive=h;this.vActive=j;return}}}}};this.MarkPoint.prototype.draw=
function(c){var e=a._rendererOptions.markPoint.slope;this.update();var f,m,p;p=!1;var s;switch(d){case "column":for(f=0;f<this.parts.length;f++)for(m=0;m<this.parts[f].cubes.length;m++)if(this.parts[f].cubes[m].height>0&&(p=!0,s=b[m]?b[m]:n.color,a.hoveredMarkPoint===this&&f===this.hActive&&m===this.vActive&&(s=GeoGlobe.Util.getShadeColor(s,20)),c.globalAlpha=l,c.globalCompositeOperation="source-over",c.shadowBlur=0,c.shadowOffsetX=0,c.shadowOffsetY=0,c.beginPath(),c.moveTo(this.parts[f].cubes[m].vertexs[0][0],
this.parts[f].cubes[m].vertexs[0][1]),c.lineTo(this.parts[f].cubes[m].vertexs[0][0],this.parts[f].cubes[m].vertexs[0][1]-this.parts[f].cubes[m].height*this.energy),c.lineTo(this.parts[f].cubes[m].vertexs[3][0],this.parts[f].cubes[m].vertexs[3][1]-this.parts[f].cubes[m].height*this.energy),c.lineTo(this.parts[f].cubes[m].vertexs[3][0],this.parts[f].cubes[m].vertexs[3][1]),c.closePath(),c.fillStyle=s,c.fill(),h!==0))c.beginPath(),c.moveTo(this.parts[f].cubes[m].vertexs[0][0],this.parts[f].cubes[m].vertexs[0][1]),
c.lineTo(this.parts[f].cubes[m].vertexs[1][0],this.parts[f].cubes[m].vertexs[1][1]),c.lineTo(this.parts[f].cubes[m].vertexs[1][0],this.parts[f].cubes[m].vertexs[1][1]-this.parts[f].cubes[m].height*this.energy),c.lineTo(this.parts[f].cubes[m].vertexs[0][0],this.parts[f].cubes[m].vertexs[0][1]-this.parts[f].cubes[m].height*this.energy),c.closePath(),c.fillStyle=GeoGlobe.Util.getShadeColor(s,-40),c.fill(),c.beginPath(),c.moveTo(this.parts[f].cubes[m].vertexs[0][0],this.parts[f].cubes[m].vertexs[0][1]-
this.parts[f].cubes[m].height*this.energy),c.lineTo(this.parts[f].cubes[m].vertexs[1][0],this.parts[f].cubes[m].vertexs[1][1]-this.parts[f].cubes[m].height*this.energy),c.lineTo(this.parts[f].cubes[m].vertexs[2][0],this.parts[f].cubes[m].vertexs[2][1]-this.parts[f].cubes[m].height*this.energy),c.lineTo(this.parts[f].cubes[m].vertexs[3][0],this.parts[f].cubes[m].vertexs[3][1]-this.parts[f].cubes[m].height*this.energy),c.closePath(),c.fillStyle=GeoGlobe.Util.getShadeColor(s,-20),c.fill(),c.shadowColor=
...
this.parts[f].cubes[m].vertexs[2][1]),c.closePath(),c.fillStyle=s,c.fill(),c.beginPath(),c.moveTo(this.parts[f].cubes[m].vertexs[2][0],this.parts[f].cubes[m].vertexs[2][1]),c.lineTo(this.parts[f].cubes[m].vertexs[2][0],this.parts[f].cubes[m].vertexs[2][1]-this.parts[f].cubes[m].height*this.energy),c.lineTo(this.parts[f].cubes[m].vertexs[3][0],this.parts[f].cubes[m].vertexs[3][1]-this.parts[f].cubes[m].height*this.energy),c.lineTo(this.parts[f].cubes[m].vertexs[3][0],this.parts[f].cubes[m].vertexs[3][1]),
c.closePath(),c.fillStyle=GeoGlobe.Util.getShadeColor(s,-40),c.fill(),c.beginPath(),c.moveTo(this.parts[f].cubes[m].vertexs[0][0],this.parts[f].cubes[m].vertexs[0][1]),c.lineTo(this.parts[f].cubes[m].vertexs[1][0],this.parts[f].cubes[m].vertexs[1][1]),c.lineTo(this.parts[f].cubes[m].vertexs[2][0],this.parts[f].cubes[m].vertexs[2][1]),c.lineTo(this.parts[f].cubes[m].vertexs[3][0],this.parts[f].cubes[m].vertexs[3][1]),c.closePath(),c.fillStyle=GeoGlobe.Util.getShadeColor(s,-20),c.fill();if(p)c.lineWidth=
...
break;case "pie":c.globalAlpha=l;for(f=0;f<1;f++){s=this.parts[f].uCentrePoint;var q=this.parts[f].tCentrePoint,u=this.parts[f].oUnderPoints,v=this.parts[f].oTopPoints,x=this.parts[f].iUnderPoints,z=this.parts[f].iTopPoints,C=!1;this.parts[f].size/2>g&&(C=!0);var B=Math.round(25),A=[],w=[],y=[],D=[];for(m=0;m<this.parts[f].sectors.length;m++)A.push(this.parts[f].sectors[m].angle),w.push(this.parts[f].sectors[m].startIndex),y.push(Math.round(this.parts[f].sectors[m].endIndex*this.energy)),D.push(b[m]?
b[m]:n.color);for(m=A.length-1;m>=0;m--)A[m]>0&&a.hoveredMarkPoint===this&&f===this.hActive&&m===this.vActive&&(D[m]=GeoGlobe.Util.getShadeColor(D[m],10));for(m=A.length-1;m>=0;m--)if(A[m]>0){c.globalCompositeOperation="destination-over";c.beginPath();c.moveTo(u[y[m]].get2d().x,u[y[m]].get2d().y);for(p=y[m]-1;p>=w[m];p--)c.lineTo(u[p].get2d().x,u[p].get2d().y);if(C)for(p=w[m];p<=y[m];p++)c.lineTo(x[p].get2d().x,x[p].get2d().y);else c.lineTo(s.get2d().x,s.get2d().y);c.fillStyle=D[m];c.fill()}if(e!==
0){for(m=A.length-1;m>=0;m--)if(A[m]>0)c.globalCompositeOperation="source-over",c.beginPath(),c.moveTo(u[y[m]].get2d().x,u[y[m]].get2d().y),C?(c.lineTo(x[y[m]].get2d().x,x[y[m]].get2d().y),c.lineTo(z[y[m]].get2d().x,z[y[m]].get2d().y)):(c.lineTo(s.get2d().x,s.get2d().y),c.lineTo(q.get2d().x,q.get2d().y)),c.lineTo(v[y[m]].get2d().x,v[y[m]].get2d().y),c.moveTo(u[w[m]].get2d().x,u[w[m]].get2d().y),C?(c.lineTo(x[w[m]].get2d().x,x[w[m]].get2d().y),c.lineTo(z[w[m]].get2d().x,z[w[m]].get2d().y)):(c.lineTo(s.get2d().x,
s.get2d().y),c.lineTo(q.get2d().x,q.get2d().y)),c.lineTo(v[w[m]].get2d().x,v[w[m]].get2d().y),c.fillStyle=GeoGlobe.Util.getShadeColor(D[m],-20),c.fill();if(C)for(m=A.length-1;m>=0;m--)if(A[m]>0){c.globalCompositeOperation="source-over";c.beginPath();c.moveTo(x[y[m]].get2d().x,x[y[m]].get2d().y);if(w[m]<B&&y[m]>B){for(p=y[m]-1;p>=B;p--)c.lineTo(x[p].get2d().x,x[p].get2d().y);for(p=B;p<=y[m];p++)c.lineTo(z[p].get2d().x,z[p].get2d().y);c.moveTo(x[w[m]].get2d().x,x[w[m]].get2d().y);for(p=w[m]+1;p<=B;p++)c.lineTo(x[p].get2d().x,
x[p].get2d().y);for(p=B;p>=w[m];p--)c.lineTo(z[p].get2d().x,z[p].get2d().y)}else{for(p=y[m]-1;p>=w[m];p--)c.lineTo(x[p].get2d().x,x[p].get2d().y);for(p=w[m];p<=y[m];p++)c.lineTo(z[p].get2d().x,z[p].get2d().y)}c.fillStyle=GeoGlobe.Util.getShadeColor(D[m],-20);c.fill()}for(m=A.length-1;m>=0;m--)if(A[m]>0){if(w[m]<B&&y[m]>B){c.globalCompositeOperation="destination-over";c.beginPath();c.moveTo(u[y[m]].get2d().x,u[y[m]].get2d().y);for(p=y[m]-1;p>=B;p--)c.lineTo(u[p].get2d().x,u[p].get2d().y);for(p=B;p<=
y[m];p++)c.lineTo(v[p].get2d().x,v[p].get2d().y);c.fillStyle=GeoGlobe.Util.getShadeColor(D[m],-20);c.fill();c.globalCompositeOperation="source-over";c.beginPath();c.moveTo(u[w[m]].get2d().x,u[w[m]].get2d().y);for(p=w[m]+1;p<=B;p++)c.lineTo(u[p].get2d().x,u[p].get2d().y);for(p=B;p>=w[m];p--)c.lineTo(v[p].get2d().x,v[p].get2d().y)}else{c.globalCompositeOperation="source-over";c.beginPath();c.moveTo(u[y[m]].get2d().x,u[y[m]].get2d().y);for(p=y[m]-1;p>=w[m];p--)c.lineTo(u[p].get2d().x,u[p].get2d().y);
for(p=w[m];p<=y[m];p++)c.lineTo(v[p].get2d().x,v[p].get2d().y)}c.fillStyle=GeoGlobe.Util.getShadeColor(D[m],-20);c.fill()}for(m=A.length-1;m>=0;m--)if(A[m]>0){c.globalCompositeOperation="source-over";c.beginPath();c.moveTo(v[y[m]].get2d().x,v[y[m]].get2d().y);for(p=y[m]-1;p>=w[m];p--)c.lineTo(v[p].get2d().x,v[p].get2d().y);if(C)for(p=w[m];p<=y[m];p++)c.lineTo(z[p].get2d().x,z[p].get2d().y);else c.lineTo(q.get2d().x,q.get2d().y);c.fillStyle=D[m];c.fill()}}}}}},_initCanvas:function(){this.canvas=[];
...
p;m++){h=0;for(var s=this._legend.col;h<s;h++)if(m%this._legend.col===h){f=10+this._legend.itemWidth/2;for(var q=0;q<h;q++)f+=a[q]+10}h=10+this._legend.itemHeight/2+((this._legend.itemHeight<this._legend.textStyle.fontSize?this._legend.textStyle.fontSize:this._legend.itemHeight)+10)*~~(m/this._legend.col);q=s=!1;this.legendCanvasContext.beginPath();this.legendCanvasContext.rect(f-this._legend.itemWidth/2,h-this._legend.itemHeight/2,this._legend.itemWidth,this._legend.itemHeight);b==="mousemove"&&
c!==void 0&&d!==void 0&&this.legendCanvasContext.isPointInPath(c,d)&&(e=s=!0);b==="mousedown"&&c!==void 0&&d!==void 0&&this.legendCanvasContext.isPointInPath(c,d)&&(q=!0);this.legendCanvasContext.beginPath();this.legendCanvasContext.font=this._legend.textStyle.fontStyle+" "+this._legend.textStyle.fontWeight+" "+this._legend.textStyle.fontSize+"px "+this._legend.textStyle.fontFamily;this.legendCanvasContext.rect(f+this._legend.itemWidth/2+10,h-this._legend.textStyle.fontSize/2,this.legendCanvasContext.measureText(this._legend.vLegendLabels[m].toString()).width,
this._legend.textStyle.fontSize);b==="mousemove"&&c!==void 0&&d!==void 0&&this.legendCanvasContext.isPointInPath(c,d)&&(e=s=!0);b==="mousedown"&&c!==void 0&&d!==void 0&&this.legendCanvasContext.isPointInPath(c,d)&&(q=!0);if(q)this._legend.itemStatuses[m]=this._legend.itemStatuses[m]===0?1:0,this.SWITCH=!0;var u=this._legend.itemStatuses[m]===0?"#808080":this._legend.itemColors[m]?this._legend.itemColors[m]:this._rendererOptions.markPoint.itemStyle.color,v=this._legend.itemStatuses[m]===0?"#808080":
this._legend.textStyle.color,u=s||q?GeoGlobe.Util.getShadeColor(u,20):u,v=s||q?GeoGlobe.Util.getShadeColor(v,20):v;this.legendCanvasContext.beginPath();this.legendCanvasContext.rect(f-this._legend.itemWidth/2,h-this._legend.itemHeight/2,this._legend.itemWidth,this._legend.itemHeight);this.legendCanvasContext.fillStyle=u;this.legendCanvasContext.fill();this.legendCanvasContext.font=this._legend.textStyle.fontStyle+" "+this._legend.textStyle.fontWeight+" "+this._legend.textStyle.fontSize+"px "+this._legend.textStyle.fontFamily;
...
1)}});
GeoGlobe.Visuals.Custom.Delaunay=GeoGlobe.Class4OL({_parent:null,canvas:[],cacheCanvas:[],canvasContext:[],cacheCanvasContext:[],MarkFace:null,markFaces:[],initialize:function(a){this.options=a;GeoGlobe.Util.extend(this,a);this._init_RendererOptions();this._initMarkFace();this.setData(this.data)},_init_RendererOptions:function(){this._rendererOptions=GeoGlobe.Util.deepExtend({},{markFace:{hoverable:!0,clickable:!0,itemStyle:{color:"rgba(255,0,0,0.5)",borderColor:"#000",borderWidth:1,shadowColor:"#000",shadowBlur:0,
shadowOffsetX:0,shadowOffsetY:0}},tooltip:{show:!0,backgroundColor:"rgba(0,0,0,0.7)",borderColor:"#333",borderRadius:0,borderWidth:0,padding:5,textStyle:{color:"#fff",fontFamily:"serif",fontSize:12,fontStyle:"normal",fontWeight:"normal"}}},this.rendererOptions)},_initMarkFace:function(){var a=this,b=this._rendererOptions.markFace.itemStyle;if(typeof b.color==="object")var c=GeoGlobe.Util.getGradientImageData(b.color);this.MarkFace=function(a,e,f,g){this.index=a;this.count=e;this.attributes=f;this.triangle=
g;this.vertices=[];this.color=typeof b.color==="object"?"rgba("+c[parseInt(e*255,10)*4]+","+c[parseInt(e*255,10)*4+1]+","+c[parseInt(e*255,10)*4+2]+","+c[3]/255+")":b.color};this.MarkFace.prototype.updateXY=function(){for(var b=4;b--;){var c=a._parent.map.project(this.triangle.geometry.coordinates[0][b]);this.x=c.x;this.y=c.y;this.vertices[b]=[this.x,this.y]}};this.MarkFace.prototype.isPointInPath=function(b,c,f){b.beginPath();b.moveTo(this.vertices[3][0],this.vertices[3][1]);for(var g=3;g--;)b.lineTo(this.vertices[g][0],
this.vertices[g][1]);b.closePath();if(b.isPointInPath(c,f))a.hoveredMarkFace=this};this.MarkFace.prototype.draw=function(c){c.shadowColor=b.shadowColor;c.shadowBlur=b.shadowBlur;c.shadowOffsetX=b.shadowOffsetX;c.shadowOffsetY=b.shadowOffsetY;c.beginPath();c.moveTo(this.vertices[3][0],this.vertices[3][1]);for(var e=3;e--;)c.lineTo(this.vertices[e][0],this.vertices[e][1]);c.closePath();c.fillStyle=a.hoveredMarkFace===this?GeoGlobe.Util.getShadeColor(this.color,20):this.color;c.strokeStyle=b.borderColor;
...
this.RESIZE=!0},hover:function(a,b){this.lastHoveredMarkFace=this.hoveredMarkFace?GeoGlobe.Util.clone(this.hoveredMarkFace,!1):null;this.hoveredMarkFace=null;for(var c=0,d=this.markFaces.length;c<d;c++)!this.hoveredMarkFace&&this.markFaces[c].isPointInPath(this.cacheCanvasContext[0],a,b);this.draw();this.hoveredMarkFace?(this.canvas[0].style.cursor="pointer",this.showTooltip("["+this.hoveredMarkFace.attributes.a+","+this.hoveredMarkFace.attributes.b+","+this.hoveredMarkFace.attributes.c+"]",a,b)):
(this.canvas[0].style.cursor="default",this.hideTooltip())},draw:function(){this.cacheCanvas[0].width=this.width;for(var a=this.markFaces.length;a--;)this.markFaces[a].draw(this.cacheCanvasContext[0]);this.canvas[0].width=this.width;this.canvasContext[0].drawImage(this.cacheCanvas[0],0,0)},showTooltip:function(a,b,c){if(this._rendererOptions.tooltip.show)this.tooltipDiv.textContent=a,this.tooltipDiv.style.top=c-15+"px",this.tooltipDiv.style.left=b+15+"px",this.tooltipDiv.style.display="block"},hideTooltip:function(){if(this._rendererOptions.tooltip.show)this.tooltipDiv.style.display=
"none"},addTo:function(a){this._parent=a;this._parent.addLayer(this)},setVisible:function(a){this.visibility=a;this.canvas[0].style.display=a?"block":"none"},setData:function(a){this.data=a;var b=this,c=setInterval(function(){clearInterval(c);b.markFaces=[];b.hoveredMarkFace=null;var d,e;e=turf.tin(a,"name");for(var f=0;f<e.features.length;f++)d=e.features[f],b.markFaces.push(new b.MarkFace(f,Math.random(),d.properties,d));b.RELOADED=!0},1)}});
...
removeLayer:function(a){for(var b=[],c=0;c<this.layers.length;c++)a!==this.layers[c].id&&b.push(this.layers[c]);this.layers=b},getLayer:function(a){for(var b=0;b<this.layers.length;b++)if(a===this.layers[b].id)return this.layers[b]}});
GeoGlobe.Visuals.Grid.Typhoon=GeoGlobe.Class4OL(GeoGlobe.Visuals,{_parent:null,canvas:[],canvasContext:[],initialize:function(a){this.options=a;GeoGlobe.Util.extend(this,a);this.particles=[];this.initParticles();this.setData(this.data)},initParticles:function(){var a=this;this.Particle=function(a,c,d){this.x=a;this.y=c;this.oldY=this.oldX=-1;this.age=d;this.opacity=1};this.Particle.prototype.updateXY=function(b,c,d){c=a._parent.map.project([this.x,this.y]);b=c.x;c=c.y;if(d)return d.x=b,d.y=c,d;return new a.Vector(b,
c)}},_initCanvas:function(){this.canvas=[];this.canvasContext=[];this.canvas.push(document.createElement("canvas"));this.canvasContext.push(this.canvas[0].getContext("2d"));this.cacheCanvas=[];this.cacheCanvasContext=[];this.cacheCanvas.push(document.createElement("canvas"));this.cacheCanvasContext.push(this.cacheCanvas[0].getContext("2d"));this.canvas[0].width=this.cacheCanvas[0].width=this.width=this._parent.map.transform.width;this.canvas[0].height=this.cacheCanvas[0].height=this.height=this._parent.map.transform.height;
this.canvas[0].style.position="absolute";this._parent.container.appendChild(this.canvas[0]);this.setVisible(this.visibility)},setVisible:function(a){this.visibility=a;this.canvas[0].style.display=a?"block":"none"},render:function(){this._initCanvas();var a,b=this;(function d(){requestAnimationFrame(d);if(b._parent.map.moving||b.RELOADED||b.RESIZE){a=b.particles.length;for(var e=new b.Vector(0,0);a--;)b.particles[a].updateXY(b.particles[a].x,b.particles[a].y,e);b.canvas[0].width=b.width;b.RELOADED&&
...
this.canvasContext[0].moveTo(b.x,b.y),this.canvasContext[0].lineTo(d.oldX,d.oldY),this.canvasContext[0].stroke());d.oldX=b.x;d.oldY=b.y}},addTo:function(a){this._parent=a;this._parent.addLayer(this)},setData:function(a){this.data=a;var b=this;this.inBounds=function(a,b){return a>=this.field.x0&&a<this.field.x1&&b>=this.field.y0&&b<this.field.y1};this.bilinear=function(a,b,c){var d=Math.floor(b),e=Math.floor(c),f=Math.ceil(b),g=Math.ceil(c);b-=d;c-=e;return this.Data[d][e][a]*(1-b)*(1-c)+this.Data[f][e][a]*
b*(1-c)+this.Data[d][g][a]*(1-b)*c+this.Data[f][g][a]*b*c};this.getValue=function(a,c){var d=(this.field.gridWidth-1-1.0E-6)*(a-this.field.x0)/(this.field.x1-this.field.x0),e=(this.field.gridHeight-1-1.0E-6)*(c-this.field.y0)/(this.field.y1-this.field.y0),f=this.bilinear("x",d,e),d=this.bilinear("y",d,e);return new b.Vector(f,d)};this.Vector=function(a,b){this.x=a;this.y=b};this.Vector.prototype.length=function(){return Math.sqrt(this.x*this.x+this.y*this.y)};this.makeParticle=function(){var a=Math.random(),
b=Math.random();return new this.Particle(a*this.field.x0+(1-a)*this.field.x1,b*this.field.y0+(1-b)*this.field.y1,1+40*Math.random())};for(var c=[],d=a.gridWidth,e=a.gridHeight,f=0,g=0;g<d;g++){c[g]=[];for(var h=0;h<e;h++){var j=a.field[f++],l=a.field[f++],j=new this.Vector(j,l);c[g][h]=j}}this.field=a;this.numParticles=5E3;for(f=0;f<this.numParticles;f++)this.particles.push(this.makeParticle());this.Data=c}});
...
addLayer:function(a){a.id?this.getLayer(a.id)||this.layers.push(a):console.error("\u56fe\u5c42id\u5c5e\u6027\u4e0d\u80fd\u4e3a\u7a7a\uff01")},removeLayer:function(a){for(var b=[],c=0;c<this.layers.length;c++)a!==this.layers[c].id&&b.push(this.layers[c]);this.layers=b},getLayer:function(a){for(var b=0;b<this.layers.length;b++)if(a===this.layers[b].id)return this.layers[b]}});
GeoGlobe.Visuals.MapV.Bubble=GeoGlobe.Class4OL({_parent:null,initialize:function(a){this.options=a;GeoGlobe.Util.extend(this,a);this.setData(this.data)},addTo:function(a){this._parent=a;this._parent.addLayer(this)},remove:function(){this._parent.removeLayer(this.id)},render:function(){var a=this._parent.map,b=new mapv.DataSet(this.data),c=this.rendererOptions;c.draw="bubble";c.dragdrawing=this.dragdrawing;c.container=this._parent.container;this._layer=new mapv.mapboxGLMapLayer(a,b,c)},setData:function(a){this.data=
a.map(function(a){return GeoGlobe.Util.extend(a.properties,{geometry:a.geometry})})}});
GeoGlobe.Visuals.MapV.Category=GeoGlobe.Class4OL({_parent:null,initialize:function(a){this.options=a;GeoGlobe.Util.extend(this,a);this.setData(this.data)},addTo:function(a){this._parent=a;this._parent.addLayer(this)},remove:function(){this._parent.removeLayer(this.id)},render:function(){var a=this._parent.map,b=new mapv.DataSet(this.data),c=this.rendererOptions;c.draw="category";c.dragdrawing=this.dragdrawing;c.container=this._parent.container;this._layer=new mapv.mapboxGLMapLayer(a,b,c)},setData:function(a){this.data=
a.map(function(a){return GeoGlobe.Util.extend(a.properties,{geometry:a.geometry})})}});
GeoGlobe.Visuals.MapV.Choropleth=GeoGlobe.Class4OL({_parent:null,initialize:function(a){this.options=a;GeoGlobe.Util.extend(this,a);this.setData(this.data)},addTo:function(a){this._parent=a;this._parent.addLayer(this)},remove:function(){this._parent.removeLayer(this.id)},render:function(){var a=this._parent.map,b=new mapv.DataSet(this.data),c=this.rendererOptions;c.draw="choropleth";c.dragdrawing=this.dragdrawing;c.container=this._parent.container;this._layer=new mapv.mapboxGLMapLayer(a,b,c)},setData:function(a){this.data=
a.map(function(a){return GeoGlobe.Util.extend(a.properties,{geometry:a.geometry})})}});
GeoGlobe.Visuals.MapV.Grid=GeoGlobe.Class4OL({_parent:null,initialize:function(a){this.options=a;GeoGlobe.Util.extend(this,a);this.setData(this.data)},addTo:function(a){this._parent=a;this._parent.addLayer(this)},remove:function(){this._parent.removeLayer(this.id)},render:function(){var a=this._parent.map,b=new mapv.DataSet(this.data),c=this.rendererOptions;c.draw="grid";c.dragdrawing=this.dragdrawing;c.container=this._parent.container;this._layer=new mapv.mapboxGLMapLayer(a,b,c)},setData:function(a){this.data=
a.map(function(a){return GeoGlobe.Util.extend(a.properties,{geometry:a.geometry})})}});
GeoGlobe.Visuals.MapV.HeatMap=GeoGlobe.Class4OL({_parent:null,initialize:function(a){this.options=a;GeoGlobe.Util.extend(this,a);this.setData(this.data)},addTo:function(a){this._parent=a;this._parent.addLayer(this)},remove:function(){this._parent.removeLayer(this.id)},render:function(){var a=this._parent.map,b=new mapv.DataSet(this.data),c=this.rendererOptions;c.draw="heatmap";c.dragdrawing=this.dragdrawing;c.container=this._parent.container;this._layer=new mapv.mapboxGLMapLayer(a,b,c)},setData:function(a){this.data=
a.map(function(a){return GeoGlobe.Util.extend(a.properties,{geometry:a.geometry})})}});
GeoGlobe.Visuals.MapV.HoneyComb=GeoGlobe.Class4OL({_parent:null,initialize:function(a){this.options=a;GeoGlobe.Util.extend(this,a);this.setData(this.data)},addTo:function(a){this._parent=a;this._parent.addLayer(this)},remove:function(){this._parent.removeLayer(this.id)},render:function(){var a=this._parent.map,b=new mapv.DataSet(this.data),c=this.rendererOptions;c.draw="honeycomb";c.dragdrawing=this.dragdrawing;c.container=this._parent.container;this._layer=new mapv.mapboxGLMapLayer(a,b,c)},setData:function(a){this.data=
a.map(function(a){return GeoGlobe.Util.extend(a.properties,{geometry:a.geometry})})}});
GeoGlobe.Visuals.MapV.Icon=GeoGlobe.Class4OL({_parent:null,initialize:function(a){this.options=a;GeoGlobe.Util.extend(this,a);this.setData(this.data)},addTo:function(a){this._parent=a;this._parent.addLayer(this)},remove:function(){this._parent.removeLayer(this.id)},render:function(){var a=this,b=this._parent.map,c=new mapv.DataSet(this.data),d=this.rendererOptions,e=new Image;e.src=this.icon;e.onload=function(){d.icon=e;d.draw="icon";d.dragdrawing=a.dragdrawing;d.container=a._parent.container;a._layer=
new mapv.mapboxGLMapLayer(b,c,d)}},setData:function(a){this.data=a.map(function(a){return GeoGlobe.Util.extend(a.properties,{geometry:a.geometry})})}});
GeoGlobe.Visuals.MapV.Intensity=GeoGlobe.Class4OL({_parent:null,initialize:function(a){this.options=a;GeoGlobe.Util.extend(this,a);this.setData(this.data)},addTo:function(a){this._parent=a;this._parent.addLayer(this)},remove:function(){this._parent.removeLayer(this.id)},render:function(){var a=this._parent.map,b=new mapv.DataSet(this.data),c=this.rendererOptions;c.draw="intensity";c.dragdrawing=this.dragdrawing;c.container=this._parent.container;this._layer=new mapv.mapboxGLMapLayer(a,b,c)},setData:function(a){this.data=
a.map(function(a){return GeoGlobe.Util.extend(a.properties,{geometry:a.geometry})})}});
...
GeoGlobe.Visuals.MapV.Text=GeoGlobe.Class4OL({_parent:null,initialize:function(a){this.options=a;GeoGlobe.Util.extend(this,a);this.setData(this.data)},addTo:function(a){this._parent=a;this._parent.addLayer(this)},remove:function(){this._parent.removeLayer(this.id)},render:function(){var a=this._parent.map,b=new mapv.DataSet(this.data),c=this.rendererOptions;c.draw="text";c.dragdrawing=this.dragdrawing;c.container=this._parent.container;this._layer=new mapv.mapboxGLMapLayer(a,b,c)},setData:function(a){this.data=
a.map(function(a){return GeoGlobe.Util.extend(a.properties,{geometry:a.geometry})})}});
GeoGlobe.Visuals.DeckGL=GeoGlobe.Class4OL(GeoGlobe.Visuals,{map:null,container:null,layers:[],_deckgl:null,initialize:function(){GeoGlobe.Visuals.prototype.initialize.apply(this,arguments);window.deck||console.error("\u4f7f\u7528DeckGL\u53ef\u89c6\u5316\u56fe\u5c42\u524d\uff0c\u9700\u5f15\u5165deckgl\u5e93\uff01")},addTo:function(){GeoGlobe.Visuals.prototype.addTo.apply(this,arguments);this.container.className="geoglobe-deckgl-container";var a=this;this._deckgl=new deck.DeckGL({container:this.container,
geoMap:this.map,onWebGLInitialized:function(b){a.fire("overlayerinit",{param:b})},onLayerClick:function(b,c,d){a.fire("overlayerclick",{param:{info:b,pickedInfos:c,event:d}})},onLayerHover:function(b,c,d){a.fire("overlayerhover",{param:{info:b,pickedInfos:c,event:d}})},layers:[]})},render:function(){for(var a=[],b=0;b<this.layers.length;b++)a.push(this.layers[b].getInnerLayer());this._deckgl.props.layers=a;this._deckgl.setProps()},addLayer:function(a){a.id?this.getLayer(a.id)||this.layers.push(a):
console.error("\u56fe\u5c42id\u5c5e\u6027\u4e0d\u80fd\u4e3a\u7a7a\uff01")},removeLayer:function(a){for(var b=[],c=0;c<this.layers.length;c++)a!==this.layers[c].id&&b.push(this.layers[c]);this.layers=b},getLayer:function(a){for(var b=0;b<this.layers.length;b++)if(a===this.layers[b].id)return this.layers[b]}});
