...
import com.tengdi.environmentalprotectionint.modules.greentax.dao.EpNoiseTaxDao;
...
@Service("epNoiseTaxService")
public class EpNoiseTaxServiceImpl extends ServiceImpl<EpNoiseTaxDao, EpNoiseTaxEntity> implements EpNoiseTaxService {

    @Override
    public PageUtils queryPage(Map<String, Object> params) {
        String epNoiseTaxName = (String)params.get("epNoiseTaxName");
        Page<EpNoiseTaxEntity> page = this.selectPage(
                new Query<EpNoiseTaxEntity>(params).getPage(),
                new EntityWrapper<EpNoiseTaxEntity>()
                        .like(StringUtils.isNotBlank(epNoiseTaxName),"epNoiseTaxName", epNoiseTaxName)
        );
